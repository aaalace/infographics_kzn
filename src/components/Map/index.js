...
export function CustomMap() {
    ...
    const Events = {
        ...
        'zilatikon': {
            ...
            'desc': 'С 1985 года в Казани — как и во многих городах СССР — существовал Клуб любителей фантастики. Именно здесь в 1987-м впервые в городе публично зачитали отрывок из книги «Хранители» — первой части «Властелина колец», вышедшей в издательстве «Детская литература» в переводе Владимира Муравьева. Через несколько лет члены КЛФ создали самый мощный в стране фестиваль для тех, кто любит книги Клиффорда Саймака и Джона Толкина, драться на дюралевых мечах, танцевать вальсы XVII века и представляться эльфийскими именами.'},
        'winter': {
